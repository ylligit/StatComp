...
#' @title Use nonparametric method to test whether two random vectors are independent.
#' @description Use nonparametric method to test whether two random vectors are independent
#' by calculating the T value in the test.
#' @param x a random vector
#' @param y another random vector
#' @return a scalar, T value, which can be used to test hypothesis later.
#' @importFrom  ks hpi
#' @examples
#' \dontrun{
#' data(faithful)
